...
const { ConcurrentPriorityQueue } = require("../../src/data-structures/concurrent-priority-queue.js");
...
describe("ConcurrentPriorityQueue", function () {
    ...
    it("should behave correctly under concurrent access", async () => {
        ...
        const priorities = dequeueResults.map(item => parseInt(item.replace('item', ''), 10));
